...
public interface unqualify_applyMapper {
    ...
    c_order selectC_orderByOrderId(@Param("id") String id);
    ...
    employee selectemployeeByEmployeeId(@Param("id") String id);
    ...
    product selectProductByProductId(@Param("id") String id);
    ...
    process selectProcessByProcessId(@Param("id") String id);
