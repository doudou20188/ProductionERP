package com.cskaoyan.controller.qualify;
...
public class unqualify {
   ...
   /* @RequestMapping("employee/get_data")
    @ResponseBody
    public List<com.cskaoyan.domain.qualify.Employee> employee_get_data() {
        List<com.cskaoyan.domain.qualify.Employee> employees = unqualifyService.selectAllEmployee();
        return employees;
   ...
   /* @RequestMapping("product/get_data")
    ...
    public Map unqualify_delete_batch(String[] ids) {
       ...
       for(String id:ids ){
        int unqualifySize = unqualifyService.deleteUnqualify_applyByunqualify(id);
       }
   ...
   /* @RequestMapping("employee/get/{id}")
    @ResponseBody
    public employeelistVO employee_get_id(@PathVariable String id) {
        Employee employee = unqualifyService.selectemployeeByEmployeeId(id);
        String departmentId = employee.getDepartmentId();
        department department=unqualifyService.selectDepartmentByDepartmentId(departmentId);
        employeelistVO employeelistVO1=new employeelistVO();
        employeelistVO1.setBirthday(employee.getBirthday());
        employeelistVO1.setBirthday(employee.getBirthday());
        employeelistVO1.setDegree(employee.getDegree());
        employeelistVO1.setEducation(employee.getEducation());
        employeelistVO1.setEducationForm(employee.getEducationForm());
        employeelistVO1.setEmpId(employee.getEmpId());
        employeelistVO1.setEmpName(employee.getEmpName());
        employeelistVO1.setJoinDate(employeelistVO1.getJoinDate());
        employeelistVO1.setIdCode(employee.getIdCode());
        employeelistVO1.setGraduateSchool(employee.getGraduateSchool());
        employeelistVO1.setMajor(employee.getMajor());
        employeelistVO1.setEmpName(employee.getEmpName());
        employeelistVO1.setDepartments(department);
        employeelistVO1.setDepartments(department);
        return employeelistVO1;
...
/*
    ...
    @ResponseBody
    public String   product_edit_judge() {
...
*/
   ...
   /* @RequestMapping("product/update_all")
    @ResponseBody
    public Map product_update_all(product product) {
        int productSize = unqualifyService.updateproductByproduct(product);
...
/*
    ...
    @ResponseBody
    public String   employee_edit_judge() {
...
*/
   ...
   /* @RequestMapping("employee/update_all")
    @ResponseBody
    public Map employee_update_all(Employee employee) {
        int employeeSize = unqualifyService.updateEmployeeByEmployee(employee);
...
/*
    ...
    @ResponseBody
    public String   order_edit_judge() {
...
*/
    ...
    @ResponseBody
    public Map order_update_all(c_order order) {
        System.out.println(order);
        int orderSize = unqualifyService.updateorderByorder(order);
    ...
    public Map measure_delete_batch(String[] ids) {
        System.out.println(ids);
     for(String id:ids) {
    int measureSize = unqualifyService.deletemeasureByMeasureId(id);
}
   ...
   /* @RequestMapping("process/get_data")
    ...
    public Map f_count_check_delete_batch(String[] ids) {
      ...
      for(String id:ids) {
          int final_count_checkSize = unqualifyService.deleteFinal_count_checkByfinal_countId(id);
      }
    ...
    public Map p_measure_check_delete_batch(String[] ids) {
        for(String id:ids) {
            int process_measure_checkSize = unqualifyService.deleteProcess_measure_checkByprocess_measure(id);
        }
...
/*删除*/
    ...
    public Map p_count_check_delete_batch(String[] ids) {
        for(String id:ids) {
            int process_count_checkSize = unqualifyService.deleteProcess_count_checkByprocess_count(id);
        }
